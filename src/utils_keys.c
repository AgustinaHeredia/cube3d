...
/*   Updated: 2024/05/23 14:38:30 by pquintan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	move_forward(t_game *game)
{
	...
	[(int)(game->player.player_y + MARGIN)] != '1' && game->map.map_game \
	[(int)(new_x - MARGIN)][(int)(game->player.player_y - MARGIN)] != '1')
	{
...
static void	move_backward(t_game *game)
{
	...
	if (game->map.map_game[(int)(game->player.player_x + MARGIN)] \
	[(int)(new_y + MARGIN)] != '1' && game->map.map_game \
	[(int)(game->player.player_x - MARGIN)][(int)(new_y - MARGIN)] != '1')
	{
		game->player.player_y = new_y;
	}
}
